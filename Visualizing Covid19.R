...
# Label the y-axis
ggplot(confirmed_cases_worldwide, aes(date, cum_cases)) + geom_line() +
...
not_china<- confirmed_cases_china_vs_world %>%
  filter(is_china == "Not " &date >= "2020-02-15")
not_china
...
ggplot(confirmed_cases_top7_outside_china) +
  geom_line(aes(date, cum_cases, group = country, colour = country)) +
  ylab("Cumulative confirmed cases")